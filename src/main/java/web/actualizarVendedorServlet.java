 ...
 * @author artur
 */
public class actualizarVendedorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Vendedor vendedorUpdate = new Vendedor(idInt, nom, ap, am);
            vendedorDAO.actualizar(vendedorUpdate);
        } catch (Exception e) {
            Logger.getLogger(actualizarVendedorServlet.class.getName()).log(Level.SEVERE, null, e);
        }
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<header>\n"
                    ...
                    + "                        </header>");
            out.println("<body>");
             out.println("<h1>Actualizar Vendedor</h1>");
            ...
            try {
                ...
                Logger.getLogger(actualizarVendedorServlet.class.getName()).log(Level.SEVERE, null, ex);
            }

            out.print("</tbody></table><hr>");

            out.println("<form action=\"actualizarVendedorServlet\" method=\"post\">\n"
                    + "  <div class=\"mb-3\">\n"
