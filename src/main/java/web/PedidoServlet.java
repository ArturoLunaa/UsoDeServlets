...
public class PedidoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<!DOCTYPE html>\n"
                ...
                + "                        <p class=\"card-text\">Inserte un registro en la tabla de Pedidos</p>\n"
                + "                        <a href=\"insertarPedidoServlet\" class=\"btn btn-primary\">Insertar</a>\n"
                + "                    </div>\n"
                + "                </div>\n"
                + "            </div>\n"
                + "            <div class=\"col-md-12 col-lg-6\">\n"
                ...
                + "                        <p class=\"card-text\">Consulte un registro en la tabla de Pedidos</p>\n"
                + "                        <a href=\"consultarPedidoServlet\" class=\"btn btn-primary\">Consultar</a>\n"
                + "                    </div>\n"
                + "                </div>\n"
                + "            </div>\n"
                + "        </div>\n"
                ...
                + "                        <p class=\"card-text\">Actualice un registro en la tabla de Pedidos</p>\n"
                + "                        <a href=\"actualizarPedidoServlet\" class=\"btn btn-primary\">Actualizar</a>\n"
                + "                    </div>\n"
                + "                </div>\n"
                + "            </div>\n"
                + "            <div class=\"col-md-12 col-lg-6\">\n"
                ...
                + "                        <p class=\"card-text\">Elimine un registro en la tabla de Pedidos</p>\n"
                + "                        <a href=\"eliminarPedidoServlet\" class=\"btn btn-primary\">Eliminar</a>\n"
                + "                    </div>\n"
                + "                </div>\n"
                + "            </div>\n"
                + "        </div>\n"
