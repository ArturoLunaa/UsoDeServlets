...
public class eliminarProductoServlet extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Producto productDelete = new Producto(idInt);
            productoDAO.eliminar(productDelete);
        } catch(Exception e){
            Logger.getLogger(eliminarProductoServlet.class.getName()).log(Level.SEVERE, null, e);
        }
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
             out.println("<header>\n"
                ...
                + "                        </header>");
            out.println("<body>");
             out.println("<h1>Eliminar Producto</h1>");
            ...
            try {
                for (Producto producto : productoDAO.seleccionar()) {
                    out.println("<tr>");
                    out.println(" <th scope=\"row\">" + producto.getIdProducto() + "</th>");
            ...
            out.println("<form action=\"eliminarProductoServlet\" method=\"post\">\n"
                    + "  <div class=\"mb-3\">\n"
