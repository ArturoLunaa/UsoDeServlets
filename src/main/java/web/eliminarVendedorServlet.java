...
public class eliminarVendedorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Vendedor vendedorDelete = new Vendedor(idInt);
            vendedorDAO.eliminar(vendedorDelete);
        } catch (Exception e) {
            Logger.getLogger(eliminarClienteServlet.class.getName()).log(Level.SEVERE, null, e);
        }
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>Eliminar Vendedor</title>");
            out.println("</head>");
            out.println("<header>\n"
                ...
                + "                        </header>");
            out.println("<body>");
              out.println("<h1>Eliminar Vendedor</h1>");
            ...
            out.println("<form action=\"eliminarVendedorServlet\" method=\"post\">\n"
                    + "  <div class=\"mb-3\">\n"
