 ...
 * @author artur
 */
public class insertarVendedorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Vendedor vendedorInsert = new Vendedor(nom, ap, am);

        try {
            vendedorDAO.insertar(vendedorInsert);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(insertarVendedorServlet.class.getName()).log(Level.SEVERE, null, ex);
        }

        out.println("<!DOCTYPE html>");
        out.println("<html>");
        out.println("<head>\n"
                + "        <title>Alta de un vendedor</title>\n"
        ...
        out.println("<header>\n"
                ...
                + "                        </header>");
        out.println("<body>");
        out.println("<h1>Insertar Vendedor</h1>");
        out.println("<form action=\"insertarVendedorServlet\" method=\"post\">\n"
                + "  <div class=\"mb-3\">\n"
