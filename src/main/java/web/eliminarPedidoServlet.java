...
public class eliminarPedidoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Pedido pedidoDelete = new Pedido(idInt);
            pedidoDAO.eliminar(pedidoDelete);
        } catch (Exception e) {
            Logger.getLogger(eliminarPedidoServlet.class.getName()).log(Level.SEVERE, null, e);
        }
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<header>\n"
                ...
                + "                        </header>");
            out.println("<body>");
              out.println("<h1>Eliminar Pedido</h1>");
            ...
            out.println("<form action=\"eliminarPedidoServlet\" method=\"post\">\n"
                    + "  <div class=\"mb-3\">\n"
