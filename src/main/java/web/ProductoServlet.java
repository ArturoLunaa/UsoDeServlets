...
public class ProductoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<header>\n"
                ...
                + "                        </li>\n"
                + "                        </header>");
        out.println("<title>Producto Servlet</title>");
        out.println("<body>");
        out.println("    <h1 class=\"text-center\">Productos</h1>\n"
                ...
                + "                        <p class=\"card-text\">Inserte un registro en la tabla de Productos</p>\n"
                + "                        <a href=\"insertarProductoServlet\" class=\"btn btn-primary\">Insertar</a>\n"
                + "                    </div>\n"
                + "                </div>\n"
                + "            </div>\n"
                + "            <div class=\"col-md-12 col-lg-6\">\n"
                ...
                + "                        <p class=\"card-text\">Consulte un registro en la tabla de Productos</p>\n"
                + "                        <a href=\"consultarProductoServlet\" class=\"btn btn-primary\">Consultar</a>\n"
                + "                    </div>\n"
                + "                </div>\n"
                + "            </div>\n"
                + "        </div>\n"
                ...
                + "                        <p class=\"card-text\">Actualice un registro en la tabla de Productos</p>\n"
                + "                        <a href=\"actualizarProductoServlet\" class=\"btn btn-primary\">Actualizar</a>\n"
                + "                    </div>\n"
                + "                </div>\n"
                + "            </div>\n"
                + "            <div class=\"col-md-12 col-lg-6\">\n"
                ...
                + "                        <p class=\"card-text\">Elimine un registro en la tabla de Productos</p>\n"
                + "                        <a href=\"eliminarProductoServlet\" class=\"btn btn-primary\">Eliminar</a>\n"
                + "                    </div>\n"
                + "                </div>\n"
                + "            </div>\n"
                + "        </div>\n"
