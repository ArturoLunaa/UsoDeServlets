...
public class eliminarClienteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Cliente clientDelete = new Cliente(idInt);
            clientDAO.eliminar(clientDelete);
        } catch(Exception e){
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<title>Eliminar Cliente</title>");
            out.println("</head>");
             out.println("<header>\n"
                ...
                + "                        </header>");
            out.println("<body>");
             out.println("<h1>Eliminar Cliente</h1>");
            ...
            out.println("<form action=\"eliminarClienteServlet\" method=\"post\">\n"
                    + "  <div class=\"mb-3\">\n"
